...
export const IPC_CHANNELS = {
  ...
  AGENT_LOCK_LIST: 'agent-lock:list',
  AGENT_LOCK_RESERVE: 'agent-lock:reserve',
  AGENT_LOCK_RELEASE: 'agent-lock:release',
  AGENT_LOCK_HEARTBEAT: 'agent-lock:heartbeat',

  // ─── Sprint 19: File Tree ───
  FILE_TREE_GET: 'filetree:get',
  FILE_TREE_READ: 'filetree:read-file',

  // Sprint 28: Auto-continue IPC channels removed — loop is now driven by stop_reason
  ...
  SPEC_GET_ACTIVE: 'spec:get-active',
  SPEC_SET_ACTIVE: 'spec:set-active',
  SPEC_RUN_PROMPT: 'spec:run-prompt',

  // ─── Sprint 29: Orchestration Settings Persistence ───
  SETTINGS_GET_ORCHESTRATION: 'settings:get-orchestration',
  SETTINGS_SET_ORCHESTRATION: 'settings:set-orchestration',

  // ─── Sprint 30: Dev Console ───
  DEVCONSOLE_GET_TOOL_REGISTRY: 'devconsole:get-tool-registry',
  DEVCONSOLE_GET_SETTINGS_SNAPSHOT: 'devconsole:get-settings-snapshot',
  DEVCONSOLE_EXPORT: 'devconsole:export',

  // ─── Sprint 36: Stream Lifecycle ───
