...
import { DEFAULT_TIER, getTierPreset } from './tierPresets';
...
// Sprint 29: Default budget sourced from tier presets
const tier2 = getTierPreset(DEFAULT_TIER);
const DEFAULT_BUDGET: BudgetConfig = {
  maxTurnsPerTask: tier2.maxTurnsPerTask,
  maxToolCallsPerTurn: tier2.maxToolCallsPerTurn,
  maxRetries: tier2.maxRetries,
  tokenBudget: tier2.tokenBudget,
  timeoutMs: tier2.timeoutMs,
  maxParallelToolCalls: tier2.maxParallelToolCalls,
  maxContextTokens: tier2.maxContextTokens,
  maxToolResultTokens: tier2.maxToolResultTokens,
};
