  ...
  return (
    <div className="h-full overflow-y-auto p-6">
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <SectionHeader title="Chat Behavior" description="Agent loop and conversation preferences." icon={<ChatIcon />} />

        <div className="glass-panel p-5 space-y-4">
          <div>
            <label className="text-xs text-matrix-text-dim block mb-1">Agent Loop (Sprint 29)</label>
            <p className="text-[9px] text-matrix-text-muted/30 mb-2">The agent automatically continues working until it calls attempt_completion or ask_followup_question. No manual toggle needed. The loop respects tier-specific max turns and rate limits. Settings are persisted across restarts.</p>
          </div>
